...
function getRandom(max) {
    let r = Math.random(); //0.0xx ~ 0.9xx 즉 1보다 작은수
...
function getResult(n1, n2) {
    ...
    따라서 반환값을 적극 활용하면 좋다
    함수를 호출한자가 무엇을 할지 예측할 수 없기 때문에
    반환된 데이터를 가지고 무엇을 할지에 대한
    결정을 호출자에게 맡기자.
    */
    return result;
}
...
//2와 5사이의 랜덤값을 원하면 호출시 getRandomByRange(2, 5)
------------------------------------------------------------------*/
